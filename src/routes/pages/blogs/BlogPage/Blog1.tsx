  ...
  return (
    <Box sx={{ maxWidth: '800px', margin: '0 auto', padding: 2 }}>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Today, I’ll guide you through a React.js practice session aimed at beginners. This session is designed to be concise
        and focused, so we won’t be delving into advanced topics like hooks, component-based structures, or prop passing in
        depth. Instead, I assume you already have a basic understanding of these concepts, including the useState hook,
        components, prop passing, basic functions (arrow or normal), and HTML.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        ...
        complexity. This hands-on approach will help you clarify some common doubts and provide a practical understanding of
        working with React.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Now, delete the existing code in <code>App.js</code> or <code>App.tsx</code> and set up a basic counter app with two
        buttons (Increment and Decrement) and a {'<p>'} or {'<h1>'} tag to display the counter.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Implement the logic to increment and decrement the counter. Once done, your basic counter app should be functional.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        For example, if the increment input field has a value of 10 and the decrement input field has a value of 5, clicking
        the increment button should increase the counter by 10, and the decrement button should decrease it by 5.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Add a “Save Record” button to save the current counter value to the appropriate array. Display these records below
        the counter app, mapping them side by side with titles “Positive Records” and “Negative Records”.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Finally, we will add the ability to delete individual records. Additionally, we will implement a feature to export
        counter records to a <code>records.json</code> file.
      </Typography>
      <List sx={{ listStyleType: 'disc', pl: 4, mb: 2 }}>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        ...
        understanding of basic React concepts and give you practical experience in building a small application. This project
        looks simple, but it can become challenging—have hope and patience.
      </Typography>
    </Box>
  );
};
